...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        tech_lead = Person.objects.create(
            name="Isa Haas",
        ...
        speech2 = Speech.objects.create(
            order=2,
            speaker=scrum_master,
            content="Alice, what did you do yesterday?",
            is_question=True,
        )
        speech3 = Speech.objects.create(
            order=3,
            speaker=tech_lead,
            content="Yesterday, I reviewed the code and discussed priorities with Bob.",
            is_question=False,
        )
        ...
        speech4 = Speech.objects.create(
            order=4,
            speaker=scrum_master,
            content="Bob, what did you do yesterday?",
            is_question=True,
            is_to_you=True,
            information=information,
        )
        probably_answer1 = ProbablyAnswer.objects.create(
            answer="I fixed the bugs from yesterday.", is_correct=True
        )
        probably_answer2 = ProbablyAnswer.objects.create(
        ...
        speech5 = Speech.objects.create(
            order=5, speaker=scrum_master, content="Ok.", is_question=False
        )

        speech6 = Speech.objects.create(
            order=6,
            speaker=scrum_master,
            content="Charlie, what did you do yesterday?",
            is_question=True,
        )
        speech7 = Speech.objects.create(
            order=7,
            speaker=qa,
        ...
        speech8 = Speech.objects.create(
            order=8,
            speaker=scrum_master,
            content="Diana, what did you do yesterday?",
            is_question=True,
        )
        speech9 = Speech.objects.create(
            order=9,
            speaker=pm,
        ...
        speech10 = Speech.objects.create(
            order=10,
            speaker=scrum_master,
            content="Eve, what did you do yesterday?",
            is_question=True,
        )
        speech11 = Speech.objects.create(
            order=11,
        ...
        speech12 = Speech.objects.create(
            order=12,
            speaker=scrum_master,
            content="Grace, what did you do yesterday?",
            is_question=True,
        )
        speech13 = Speech.objects.create(
            order=13,
            speaker=designer,
        ...
        speech14 = Speech.objects.create(
            order=14,
            speaker=scrum_master,
            content="Bob, what will you do today?",
            is_question=True,
            is_to_you=True,
            information=information,
        )
        ...
        speech15 = Speech.objects.create(
            order=15, speaker=scrum_master, content="Ok. Great!", is_question=False
        )

        speech16 = Speech.objects.create(
            order=16,
            speaker=scrum_master,
            content="Alice, what will you do today?",
            is_question=True,
        )
        speech17 = Speech.objects.create(
            order=17,
            speaker=tech_lead,
        ...
        speech18 = Speech.objects.create(
            order=18,
            speaker=scrum_master,
            content="Charlie, what will you do today?",
            is_question=True,
        )
        speech19 = Speech.objects.create(
            order=19,
            speaker=qa,
        ...
        speech20 = Speech.objects.create(
            order=20,
            speaker=scrum_master,
            content="Diana, what will you do today?",
            is_question=True,
        )
        speech21 = Speech.objects.create(
            order=21,
            speaker=pm,
        ...
        speech22 = Speech.objects.create(
            order=22,
            speaker=scrum_master,
            content="Eve, what will you do today?",
            is_question=True,
        )
        speech23 = Speech.objects.create(
            order=23,
            speaker=product_owner,
        ...
        speech24 = Speech.objects.create(
            order=24,
            speaker=scrum_master,
            content="Grace, what will you do today?",
            is_question=True,
        )
        speech25 = Speech.objects.create(
            order=25,
            speaker=designer,
        ...
        speech26 = Speech.objects.create(
            order=26,
            speaker=scrum_master,
            content="Bob, do you have any blocks?",
            is_question=True,
            is_to_you=True,
            information=information,
        )
        ...
        speech27 = Speech.objects.create(
            order=27,
            speaker=scrum_master,
            content="Alice, do you have any blocks?",
            is_question=True,
        )
        speech28 = Speech.objects.create(
            order=28,
            speaker=tech_lead,
        ...
        speech29 = Speech.objects.create(
            order=29,
            speaker=scrum_master,
            content="Charlie, do you have any blocks?",
            is_question=True,
        )
        speech30 = Speech.objects.create(
            order=30, speaker=qa, content="No blocks for today.", is_question=False
        )

        speech31 = Speech.objects.create(
            order=31,
            speaker=scrum_master,
            content="Diana, do you have any blocks?",
            is_question=True,
        )
        speech32 = Speech.objects.create(
            order=32, speaker=pm, content="No blocks, all is good.", is_question=False
        )

        speech33 = Speech.objects.create(
            order=33,
            speaker=scrum_master,
            content="Eve, do you have any blocks?",
            is_question=True,
        )
        speech34 = Speech.objects.create(
            order=34,
            speaker=product_owner,
        ...
        speech35 = Speech.objects.create(
            order=35,
            speaker=scrum_master,
            content="Grace, do you have any blocks?",
            is_question=True,
        )
        speech36 = Speech.objects.create(
            order=36,
            speaker=designer,
        ...
        speech37 = Speech.objects.create(
            order=37,
            speaker=scrum_master,
